...
public class Adrenaline extends RareProperty {
    ...
    public Adrenaline(RareProperties plugin) {
        ...
        attributeKey = new NamespacedKey(plugin, "adrenaline");
    }
    ...
    public void applyEffect(Player player, Event event) {
        ...
        AttributeModifier attributeModifier = new AttributeModifier(attributeKey, RareProperties.propertyConfig.adrenalineSize * getLevel(),
